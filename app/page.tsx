    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .avatar { width: 32px; height: 32px; border-radius: 50%; cursor: pointer; border: 2px solid #e0e0e0; flex-shrink: 0; object-fit: cover; }
        ...
        .source-dot { display: inline-block; padding: 1px 6px; border-radius: 4px; font-size: 9px; font-weight: 600; text-transform: uppercase; background: #f0f0f0; color: #888; margin-left: auto; flex-shrink: 0; }
                ...
                {displayPhotos.map(photo => (
                  <div key={photo.id} className="card" onClick={() => setSelected(photo)}>
                    ...
                    <div className="card-footer">
                      ...
                      <span className="source-dot">{photo.source}</span>
                    </div>
                  </div>
                ))}
              </div>
