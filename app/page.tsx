  ...
  return (
    <>
      ...
      <main style={{ minHeight: "100vh" }}>
        ...
        {toastMsg && <div className={`toast-container ${toastMsg.includes("synthesizing") ? "toast-thinking" : ""}`}>{toastMsg.includes("✨") ? <><span className="toast-sparkle">✨</span> <span>{toastMsg.replace("✨ ", "")}</span></> : toastMsg}</div>}
      </main>
    </>
  );
}