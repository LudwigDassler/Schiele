  ...
  return (
    <>
      ...
      <main style={{ minHeight: "100vh" }}>
        ...
        {toastMsg && <div className={`toast-container ${toastMsg.includes("synthesizing") ? "toast-thinking" : ""}`}>{toastMsg.includes("✨") ? <><div className="mini-sphere-wrap"><div className="mini-sphere" /></div> <span>{toastMsg.replace("✨ ", "")}</span></> : toastMsg}</div>}
      </main>
    </>
  );
}