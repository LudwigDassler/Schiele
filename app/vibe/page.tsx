  ...
  return (
    <div className="min-h-screen bg-[#020104] text-white overflow-x-hidden overflow-y-auto flex flex-col relative font-sans">
      ...
      <header className="w-full px-6 py-5 flex justify-between items-center fixed top-0 z-50 bg-[#020104]/60 backdrop-blur-xl border-b border-white/5">
        ...
        <div className="font-sync text-xs md:text-sm tracking-[0.3em] font-bold text-white uppercase opacity-90 text-center flex-1 pr-[60px] md:pr-[80px]">
      ...
      <div className="w-full max-w-6xl mx-auto mt-24 px-4 flex flex-col items-center z-10 relative">
        ...
        {/* ИЗОБРАЖЕНИЕ */}
        <div className="w-full flex justify-center items-center mb-6 relative group min-h-[50vh] md:min-h-[70vh] bg-black/20 rounded-xl border border-white/5 overflow-hidden">
          ...
          <img 
            ...
            className="max-h-[75vh] w-auto max-w-full object-contain shadow-[0_30px_60px_rgba(0,0,0,0.8)] relative z-10 p-2"
            onError={(e) => {
        ...
        {/* КОНТРОЛЬНАЯ ПАНЕЛЬ (Человеческие иконки и размеры) */}
        <div className="w-full max-w-4xl mx-auto glass-panel p-4 md:px-6 md:py-4 flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1">
            <span className="font-inter text-[8px] text-neutral-400 tracking-[3px] uppercase mb-1">Resonance</span>
          ...
          <div className="flex gap-2 justify-center md:justify-end flex-1">
            ...
            {/* Иконка Комментариев (Чатик) */}
            <button onClick={() => setShowCommentsModal(true)} className="btn-elegant border-neutral-700 text-neutral-300" title="Comments">
              <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
